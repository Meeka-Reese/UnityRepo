...
public class NumberReader : MonoBehaviour
{
    ...
    {
    using Tensor inputTensor = TextureConverter.ToTensor(inputTexture,  channels: 1,width: 28, height: 28);
        ...
        if (gridManager.PurpleFlower)
        {
            Debug.Log("This is a purple flower");
            Flower = true;
