    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // sample the texture
                fixed4 Iterative = tex2D(_MainTex, i.uv.xy + uvdis);
                fixed4 Iterative2 = (Iterative.xyz + uvdis, Iterative.a);
                fixed4 col = ((Iterative2 * Iterative) * (.5 * Iterative));
                //To Return to normal fog, turn col back to nromal and get rid of UVdis shit
                float cutoff = i.uv.z;
