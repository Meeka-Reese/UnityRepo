    ...
    Properties
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _MainTex, _GradientNoise, _SecondTex, _SecondGrad, _SquiggleImage, _MossTexture;
            ...
            {
                float4 Moss = tex2D(_MossTexture, (i.uv + -.01) * .1);
                Moss.a = Moss.g;
                float4 Moss2 = tex2D(_MossTexture, i.uv *.8);
                Moss2.a = Moss2.g;
