    ...
    Properties
{
    ...
    _MossTexture ("MossTexture", 2D) = "white" {}
    _Fade ("Fade", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _MainTex, _GradientNoise, _SecondTex, _SecondGrad, _SquiggleImage, _MossTexture, _Sparkle;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float4 Sparkle = tex2D(_Sparkle, i.uv * 90 * gradientValue);
                Sparkle = float4(1,1,1,1) - Sparkle;
                float4 Moss = tex2D(_MossTexture, (i.uv + -.9) * 20 * gradientValue * gradientValue2);
                Moss.a = Moss.g;
